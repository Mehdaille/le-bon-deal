...
if ( ! class_exists( 'Astra_Loop' ) ) :
	...
	class Astra_Loop {
		...
		/**
		 * Add wrapper div 'ast-row' for Astra template parts.
		 *
		 * @since  1.2.7
		 * @return void
		 */
		...
		/**
		 * Add closing wrapper div for 'ast-row' after Astra template parts.
		 *
		 * @since  1.2.7
		 * @return void
		 */
