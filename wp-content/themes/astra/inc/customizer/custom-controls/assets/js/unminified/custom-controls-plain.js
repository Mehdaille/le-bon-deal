...
(function (factory) {
  ...
  (function (undef) {
	  ...
	  function normalize(name, baseName) {
		  ...
		  if (name) {
			  ...
			  if (name[0].charAt(0) === '.' && baseParts) {
				  //Convert baseName to array, and lop off the last parts,
	  ...
	  //Creates a parts array for a relName where first parts is plugin ID,
	  //second parts is resource ID. Assumes relName has already been normalized.
