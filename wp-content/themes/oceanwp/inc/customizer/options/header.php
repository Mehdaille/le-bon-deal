					...
					'ocean_custom_vertical_header_section' => [
						...
						'options' => [
							'ocean_vertical_header_template' => [
								...
								'desc' => esc_html__( 'Select a template made in OceanWP > My Library to replace the top parts of the Vertical Header (logo, navigation and search).', 'oceanwp' ),
							...
							'ocean_vertical_header_bottom_template' => [
								...
								'desc'              => esc_html__( 'Select a template made in OceanWP > My Library to replace the bottom parts of the Vertical Header.', 'oceanwp' ),
								'section'           => 'ocean_custom_vertical_header_section',
								'transport'         => 'refresh',
								'default'           => '0',
								'priority'          => 50,
