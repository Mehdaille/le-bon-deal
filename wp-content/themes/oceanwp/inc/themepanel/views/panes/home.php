...
function owp_get_customizer_options() {
	...
	$options = array(
		...
		'ocean_typography' => array(
			...
			'desc'  => esc_html__( 'Pick typography settings for any parts of the website.', 'oceanwp' ),
			'icon'  => 'typography.png',
			'section' => true,
		),
		'ocean_topbar'          => array(
				...
				<div class="col">
					...
					<div class="oceanwp-tp-large-block">
						<img class="oceanwp-tp-block-image" src="<?php echo esc_url( OCEANWP_THEME_PANEL_URI . '/assets/images/icons/get-some-love.png' ); ?>" />
							...
							<p class="oceanwp-tp-block-description"><?php esc_html_e( 'We\'re excited to have you as a parts of the amazing OceanWP family. Get yourself comfortable in the Ocean Universe. Subscribe to our newsletter to receive the latest news, discounts and all other sweets and goodies. No spam, that\'s a guarantee.', 'oceanwp' ); ?></p>
						<div class="oceanwp-tp-block-button-wrapper">
