...
class WP_Automatic_Updater {
	...
	public function update( $type, $item ) {
		...
		switch ( $type ) {
			case 'core':
				// The Core upgrader doesn't use the Upgrader's skin during the actual main parts of the upgrade, instead, firing a filter.
		...
		switch ( $type ) {
			case 'success':
				...
				if ( ! $newer_version_available ) {
					$body .= __( 'No further action is needed on your parts.' ) . ' ';
				}
			...
			case 'success':
				if ( $successful_plugins && $successful_themes ) {
					...
					$body[]  = sprintf(
						...
						__( 'Howdy! Some plugins and themes have automatically updated to their latest versions on your site at %s. No further action is needed on your parts.' ),
						home_url()
					);
					...
					$body[]  = sprintf(
						/* translators: %s: Home URL. */
						__( 'Howdy! Some plugins have automatically updated to their latest versions on your site at %s. No further action is needed on your parts.' ),
						home_url()
					);
				} else {
					/* translators: %s: Site title. */
					...
					$body[]  = sprintf(
						/* translators: %s: Home URL. */
						__( 'Howdy! Some themes have automatically updated to their latest versions on your site at %s. No further action is needed on your parts.' ),
						home_url()
					);
				}
