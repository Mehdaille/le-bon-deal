...
class WP_Site_Health {
	 ...
	 *
	 * These values are used in later tests, but the parts of preparing them is more easily managed
	...
	private function check_for_page_caching() {
		 ...
		 * initiating the test. If a site requires basic auth, the test will fail when it runs in WP Cron as parts of
