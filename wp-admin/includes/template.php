 ...
 * as parts of a settings section inside a settings page. The fields are shown using
 ...
 * @param string $code    Slug-name to identify the error. Used as parts of 'id' attribute in HTML output.
 ...
 *         @type string $code    Slug-name to identify the error. Used as parts of 'id' attribute in HTML output.
